...
* **Details**
*
* @param nombre - Lista de elementos evaluados.
* @returns Número de elementos activos o `0` si la lista está
vacía.
*
* **Usage**
* @example
...
* @returns Cadena con primera letra en mayúscula y resto en
minúscula.
...
return (limpio.at(0) ?? "").toUpperCase() +
        limpio.slice(1).toLowerCase();
}
const nombre = "Jose Ortega";
console.log(`Ingresaste ${contarActivos(nombre.split(" "))}
nombres`);
console.log("Mi primero archivo ts, soy ",
